class php {
    ...
    $packages = ['php5','php5-gearman', 'php5-mcrypt', 'php-xml-parser', 'php5-xdebug', 'php5-mysql', 'php5-cli', 'php5-curl', 'php5-fpm', 'libssh2-1-dev', 'php-apc', 'php-pear', 'php5-gd', 'php5-imagick']
    package { $packages:
        ensure => latest,
